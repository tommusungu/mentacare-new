...
import { Heart, ExternalLink, Github, Twitter, Mail, Globe } from "lucide-react-native"
      ...
      <View className="p-6">
        ...
        <View className="mb-6">
          ...
          <View className={`p-4 rounded-xl ${isDark ? "bg-[#1E1E1E]" : "bg-[#F5F5F5]"}`}>
            <Text className={`text-base ${isDark ? "text-white" : "text-black"}`}>
              Mentacareplatform designed to make mental health care more accessible. Our mission is to
        ...
        <View className="mb-6">
          ...
          <View className="flex-row flex-wrap justify-between">
            ...
            <TouchableOpacity
              className={`flex-row items-center p-3 mb-3 rounded-lg ${isDark ? "bg-[#1E1E1E]" : "bg-[#F5F5F5]"} w-[48%]`}
              onPress={() => handleLinkPress("https://github.com/mentacare")}
            >
              <Github size={20} color={isDark ? "#FFFFFF" : "#000000"} />
              <Text className={`ml-2 ${isDark ? "text-white" : "text-black"}`}>GitHub</Text>
            </TouchableOpacity>
          </View>
        </View>
